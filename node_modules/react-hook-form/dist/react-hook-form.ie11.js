...
function useForm(_a) {
    ...
    var executeSchemaValidation = useCallback(function (payload) { return __awaiter(_this, void 0, void 0, function () {
        var fieldErrors, isMultipleFields, names, validFieldNames, firstFieldName, hasError;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    hasError = fieldErrors[firstFieldName];
                    schemaErrorsRef.current = isMultipleFields
                        ? fieldErrors
                        : hasError
                            ? __assign(__assign({}, schemaErrorsRef.current), (_a = {}, _a[firstFieldName] = fieldErrors[firstFieldName], _a)) : omitValidFields(schemaErrorsRef.current, names);
                    ...
                    if (isMultipleFields) {
                        ...
                        renderBaseOnError(firstFieldName, hasError ? schemaErrorsRef.current : {});
                    }
